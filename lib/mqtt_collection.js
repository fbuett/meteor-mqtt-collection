 ...
 * added to Collection package for convenience
*/

Mongo.Collection.prototype.mqttPublish = function(topic, message) {
	var self = this;
	if(!this._mqttClient) return;
	...
	if((typeof topic == "string" || topic instanceof String) && 
		(typeof message == "string" || message instanceof String || 
			typeof message == "buffer" || message instanceof Buffer)) {
